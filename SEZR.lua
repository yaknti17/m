...
local SEZR = io.open("SEZR", 'w')
SEZR:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 SEZR.lua
done
]])
SEZR:close()
...
local msg_id = msg.id
Redis:incr(SEZR..'SEZR:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
Redis:incr(SEZR.."SEZR:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(SEZR.."SEZR:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(SEZR.."SEZR:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(SEZR.."SEZR:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(SEZR.."SEZR:Lock:Contact"..msg_chat_id)
...
Redis:del(SEZR.."SEZR:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SEZR.."SEZR:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(SEZR.."SEZR:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SEZR.."SEZR:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(SEZR.."SEZR:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(SEZR.."SEZR:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(SEZR.."SEZR:Change:Name:Bot"..msg.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(SEZR..'SEZR:Num:Add:Bot'),"md",true)  
end
...
if not Redis:get(SEZR.."SEZR:BotFree") then
...
local TotalMsg = Redis:get(SEZR..'SEZR:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(SEZR..'SEZR:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(SEZR.."SEZR:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(SEZR.."SEZR:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(SEZR.."SEZR:Set:Id:Groups") or Redis:get(SEZR.."SEZR:Set:Id:Group"..msg_chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد جهاتك المضافه هنا *~ '..(Redis:get(SEZR.."SEZR:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
if not msg.ControllerBot and not Redis:set(SEZR.."SEZR:SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uui9u'}, },}}
...
Redis:setex(SEZR.."SEZR:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SEZR.."SEZR:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SEZR.."SEZR:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(SEZR.."SEZR:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local TextingDevSEZR = Redis:get(SEZR..'SEZR:Texting:DevSEZR')
if TextingDevSEZR then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevSEZR,"md",true)  
else
...
Redis:setex(SEZR.."SEZR:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
if text == (Redis:get(SEZR.."SEZR:Name:Bot") or "السلطان") then
local NamesBot = (Redis:get(SEZR.."SEZR:Name:Bot") or "السلطان")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
if text == '/start' then
Redis:sadd(SEZR..'SEZR:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(SEZR.."SEZR:Start:Bot") then
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(SEZR.."SEZR:Name:Bot") or "السلطان")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(SEZR.."SEZR:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
