...
io.write('\27[1;31mابعت يا سيزر توكن البوت يلا \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mالتوكن غلط ياض يا سيزر \nBot Token is Wrong\n')
else
io.write('\27[1;34mتم حفظ التوكن يا سيزر \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34mلم يتم حفظ التوكن ياض يا سيزر جرب تاني \nToken not saved, try again')
end 
os.execute('lua SEZR.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mابعت يا سيزر يوزر المطور الاساسي \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mحفظت اليوزر يا سيزر \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ اليوزر يا سيزر جرب تاني \nDeveloper UserName not saved\n')
end 
os.execute('lua SEZR.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mابعت ايدي المطور الاساسي يا سيزر \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ الايدي يا سيزر \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ الايدي ياض يا سيزر جرب تاني \nDeveloper ID not saved\n')
end 
os.execute('lua SEZR.lua')
end
...
ControllerAll = false
local ListSudos ={Sudo_Id,1825532106}  
...
local N = (Redis:get(SEZR.."Name:Bot") or "ريبورتر")
...
{
{text = '• 𝙍𝙀𝘽𝙊𝙍𝙏𝙀𝙍 •', url='https://https://t.me/RBBOU'},
},
}
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 'https://t.me/RBBOU'}, },}}
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(Redis:scard(SEZR..'SEZR:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(SEZR..'SEZR:Num:User:Pv') or 0)..'*',"md",true)  
end
...
NamesBot = (Redis:get(SEZR.."SEZR:Name:Bot") or "ريبورتر")
...
{
{text = selva, url = 't.me/RBBOU'}, 
},
{
{text = Grosupsw, url = 't.me/RBBOU'}, 
},
{
{text = '𓄼•اضف البوت لمجموعتك•𓄹', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
if text == 'المبرمج سيزر' or text == 'سيزر' or text == 'مبرمج السورس' or text == '𓄼 المبرمج سيزر 𓄹' then    
...
{
{text = '𓄼•ʙᴏᴛ•𓄹',url="t.me/SEZR8Bot"}
},
{
{text = '𓄼•اضف البوت لمجموعتك•𓄹', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = '𓄼•• 𝙍𝙀𝘽𝙊𝙍𝙏𝙀𝙍 ••𓄹', url = 't.me/RBBOU'}, 
},
}
}
...
local NamesBot = (Redis:get(SEZR.."SEZR:Name:Bot") or "ريبورتر")
local BotName = {
...
if text == (Redis:get(SEZR.."SEZR:Name:Bot") or "ريبورتر") then
local photo = LuaTele.getUserProfilePhotos(SEZR)
local UserInfo = LuaTele.getUser(SEZR)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
local CmdStart = '*\n ◉ أهلآ بك في بوت '..(Redis:get(SEZR.."SEZR:Name:Bot") or "ريبورتر")..
...
{
{text = '𓄼•مبرمج السورس•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '• 𝙍𝙀𝘽𝙊𝙍𝙏𝙀𝙍 •', url = 'https://t.me/RBBOU'}, 
},
...
data = {
{
{text = '𓄼 المبرمج سيزر 𓄹',type = 'text'}
},
{
...
{
{text = '𓄼 اضف اسم للمطور 𓄹',type = 'text'},{text = '𓄼 حذف اسم المطور 𓄹', type = 'text'},
},
{
{text = '𓄼 تعيين قناه الاشتراك 𓄹',type = 'text'},{text = '𓄼 حذف قناه الاشتراك 𓄹', type = 'text'},
},
{
{text = '𓄼 اضف كليشه المطور 𓄹',type = 'text'},{text = '𓄼 حذف كليشه المطور 𓄹', type = 'text'},
},
{
{text = '𓄼 اضف كليشه ستارت 𓄹',type = 'text'},{text = '𓄼 حذف كليشه ستارت 𓄹', type = 'text'},
},
{
{text = '𓄼 القائمه الرئيسيه 𓄹',type = 'text'},
},
